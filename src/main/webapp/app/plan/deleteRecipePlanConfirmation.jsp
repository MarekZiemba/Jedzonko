...
<html>
<head>
  <title>Usuwanie przepisu z planu</title>
</head>
<body>
...
<div class="dashboard-content border-dashed p-3 m-4">
  <div class="row border-bottom border-3 p-1 m-1">
    ...
    <div class="col d-flex justify-content-end mb-2 noPadding">
      <form method="post" action="${pageContext.request.contextPath}/recipePlanDelete">
        ...
        <td class="col-2 center">
          <a href="${pageContext.request.contextPath}/app/plan/details?id=${planId}" class="btn btn-info rounded-0 text-light m-1">Anuluj</a>
        </td>
      </form>
    </div>
  </div>
